...
<div id="sidebar-wrapper">
    ...
    <?php if ($user_role == 1) : ?>
        ...
        <div class="list-group list-group-flush">
            <a href="going-management" class="list-group-item list-group-item-action bg-transparent text-color-sidebar active small"><i class='bx bx-book me-2'></i> Gestion de Ida</a>
        </div>
        <div class="list-group list-group-flush">
            <a href="return-management" class="list-group-item list-group-item-action bg-transparent text-color-sidebar active small"><i class='bx bx-book me-2'></i> Gestion de Vuelta</a>
        </div>
        <div class="list-group list-group-flush">
