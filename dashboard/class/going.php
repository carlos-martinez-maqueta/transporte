...
class Going { 
    ...
    {
        global $conn;
        $sql = "INSERT INTO tbl_idas (origen, destino,  hora_salida, hora_llegada, tiempo_viaje, precio, reserva, fecha, estado) 
    ...
    public static function editGoingId($id, $origen, $destino, $hora_salida, $hora_llegada, $tiempo_estimado, $precio, $reserva, $estado)
    {
        global $conn;
        $sql = "UPDATE tbl_idas SET origen=:origen, destino=:destino, hora_salida=:hora_salida, hora_llegada=:hora_llegada, tiempo_viaje=:tiempo_estimado, precio=:precio, reserva=:reserva, estado=:estado WHERE id=:id";
        $stmt = $conn->prepare($sql);
