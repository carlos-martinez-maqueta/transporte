...
<?php if ($user_role == 1) : ?>
    ...
    <div class="container-fluid px-4">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 d-flex align-items-center gap-2 font_two">Pagina <i class='bx bx-chevrons-right'></i> Gestion Mejores Destinos</h1>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form id="addBest" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="editarModal" tabindex="-1" aria-labelledby="editarModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form id="editBest" method="POST" enctype="multipart/form-data">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="col-12">
                                ...
                                <div class="form-floating mb-3">
                                    <textarea class="form-control" id="title" placeholder="Escribe el título aquí" name="titulo" style="height: 100px;" required></textarea>
        ...
        <div class="row">
            <div class="col-lg-12 ">
                <div class="table-responsive table-light shadow small-table p-3">
                    <table class="table p-lg-4" id="table-best">
...
<script src="assets/js/best/get-best.js"></script>
<script src="assets/js/best/add-best.js"></script>
<script src="assets/js/best/edit-best.js"></script>
<script src="assets/js/best/delete-best.js"></script>
<script>
