...
<?php if ($user_role == 1) : ?>
    ...
    <div class="container-fluid px-4">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 d-flex align-items-center gap-2 font_two"><i class="bx bx-library me-1"></i> Listado Origen</h1>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form id="addOrigin" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="editarModal" tabindex="-1" aria-labelledby="editarModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form id="editOrigin" method="POST" enctype="multipart/form-data">
                    <div class="modal-content">
                        <div class="modal-header">
        ...
        <div class="row">
            <div class="col-lg-12 ">
                <div class="table-responsive table-light shadow small-table p-3">
                    <table class="table p-lg-4" id="table-origin">
...
<script src="assets/js/origin/get-origin.js"></script>
<script src="assets/js/origin/add-origin.js"></script>
<script src="assets/js/origin/edit-origin.js"></script>
<script src="assets/js/origin/delete-origin.js"></script>