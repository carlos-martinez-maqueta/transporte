...
$(document).ready(function () {
  dataTable = $("#table-comments").DataTable({
    ordering: false,
    language: {
    ...
    success: function (data) {
      ...
      $.each(data, function (index, result) {
        ...
        var newRow = '<tr>' +
          ...
          '<td class="align-middle text-center">' + result.titulo + '</td>' +
          '<td class="align-middle text-center">' + result.parrafo + '</td>' +
          '<td class="align-middle text-center">' + result.nombre + '</td>' +
          '<td class="align-middle text-center">' + result.cargo + '</td>' +
