$(document).ready(function() {  
    ...
    $(document).on('click', '.editar-bla', function() {
      ...
      $.ajax({
        url: 'config/booking/get-reserva-bla.php', // Cambia esta URL a la ruta de tu script PHP
        method: 'POST',
        data: { id: reservaId },
        dataType: 'json',
        ...
        //   $('#estadoReservaBla').val(response.estado);
        var plantillaHTML = '';
        ...
        const seatValue = $(this).attr('data-value');
          ...
          // Rellenar otros campos según los datos recibidos
        },
