...
$(document).on("click", ".edit", function() {
    ...
    $("#editarModal .modal-body #title").val('');
    ...
    $.ajax({
        ...
        method: "POST",
        data: {
            action: "get_all_best_id",
            resultId: resultId,
        },
        dataType: "json",
        success: function(data) {
            $("#editarModal .modal-body #id").val(data.id);
            $("#editarModal .modal-body #title").val(data.title);
            $("#editarModal .modal-body #parrafo").val(data.subtitle);
