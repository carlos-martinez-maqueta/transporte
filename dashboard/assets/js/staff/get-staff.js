  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $.each(data, function (index, result) {
        ...
        var referencia_id_text = (result.referencia == null) ? 'PRINCIPAL' : result.referencia;
        ...
        var newRow = '<tr>' +
          ...
          '<td class="align-middle text-center">' + rol_id_text + '</td>' +
          '<td class="align-middle text-center">' + referencia_id_text + '</td>' +
